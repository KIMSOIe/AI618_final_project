...
def parse_args_and_config():
    ...
    parser.add_argument(
        "--langevin_steps", type=int, default=10, help="number of steps involved"
    )
    parser.add_argument(
        "--langevin_lr", type=float, default=1e-4, help="number of steps involved"
    )
    parser.add_argument(
        "--deg", type=str, required=False, help="Degradation"
    )
    parser.add_argument(
        "--sigma_0", type=float, required=False, help="Sigma_0"
    )
    parser.add_argument(
    ...
    parser.add_argument('--gamma', type=float, default=2.2, help='Gamma value for gamma degradation')
